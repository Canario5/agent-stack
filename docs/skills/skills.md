...
| 5 | [find-skills](./find-skills.md) | `vercel-labs/skills` (`find-skills`) | Discovery / workflow extension | Trial | Find and install reusable skills from the skills.sh ecosystem. |
